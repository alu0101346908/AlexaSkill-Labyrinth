...
const NewWorldIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        switch (AnswerValue){
            ...
            case 'mediano':
                CurrentWorld = worldmodule.World(6,6, "mediano");
                break;

            case 'grande':
                CurrentWorld = worldmodule.World(8,8, "grande");
                break;
...
const AnswerDirectionIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        player_position_package = worldmodule.ManageDirection(AnswerValue,CurrentWorld,player_position_package);
