...
const languageStrings = {
  en: {
    translation: {
      WELCOME_MESSAGE: 'Welcome to the maze trial. Prepare a challenge',
      HELLO_MESSAGE: 'Hello World!',
      WORLD_EXIST_MESSAGE: 'There is already a world, if you want to restart, say restart world, if you want to create another one, say create world again',
      HELP_MESSAGE: 'You can say hello to me. How can I help?',
      ENTER_LABYRINTH_MESSAGE: 'You enter the maze',
      MISSING_WORLD_MESSAGE : 'There is no maze, create one before starting saying create small world, create normal world or create big world',
      NOT_A_OBJECT_MESSAGE: 'You are not above an object, move to the place where the object lies and try it again',
      FOUND_BOMB_MESSAGE: 'You found a bomb, you pick it up',
      FOUND_HATCHET_MESSAGE: 'You found a hatchet, you pick it up',
      CANT_USE_OBJECT_MESSAGE: 'You can not do that, try it again',
      NOT_A_BUSH_MESSAGE: 'There is no bush at direction %s',
      USED_HATCHET_MESSAGE: 'The hatchet has been used to eliminate the bush at direction %s',
      MISSING_OBJECT_MESSAGE: 'You do not have a %s try again',
      USE_OBJECT_MESSAGE: 'What direction do you want to use the object at? ',
      EMPTY_INVENTORY_MESSAGE: 'Your inventory is empty, first get an object',
      A_HATCHET_MESSAGE: 'a hatchet ',
      A_BOMB_MESSAGE: 'a bomb ',
      HAVE_MESSAGE: 'You have ',
      CHECKPOINT_NOT_FOUND_MESSAGE: 'Could not be found any checkpoint called %s',
      CHECKPOINT_FOUND_MESSAGE: 'Found checkpoint called %s. Returning to position %s %s',
      CHECKPOINT_CREATED_MESSAGE: 'It has been created a checkpoint called %s at x equals %s and y equals %s. You have %s checkpoints',
      PLAYER_SURROUNDINGS_MESSAGE: '. On your right there is a %s. Ahead, there is a %s. On your left, there is a %s. Behind you, there is a %s',
      STEPPED_OBJECT_MESSAGE: '. You are above an object',
      REACHED_GOAL_MESSAGE: 'Congrats! You made it to the goal! The maze is going to self destruct.',
      CANT_MOVE_MESSAGE: 'You can not go %s because there is a wall',
      MOVE_MESSAGE: 'You move %s',
      RESTART_LABYRINTH_MESSAGE: 'A new maze has been created. You enter the maze',
      UNSUPPORTED_SIZE_MESSAGE: 'That world size is not supported, try with small, normal or big',
      PLAYER_SURROUNDINGS_START_MESSAGE: '. On your right there is a %s. Ahead, there is a %s. On your left, there is a %s. Behind you, there is a %s.',
      LABYRINTH_HELP_MESSAGE: 'I hear your despair. How can I help you?',
      GOODBYE_MESSAGE: 'Goodbye!',
      REFLECTOR_MESSAGE: 'You just triggered %s',
      CANCEL_MESSAGE: 'You have surrended to the maze',
      FALLBACK_MESSAGE: 'Your voice has been lost beyond the walls. Can you repeat your last words?',
